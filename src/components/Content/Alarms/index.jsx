	...
	return (
		<Wrapper>
			{(typeof allValues?.alarms?.surge_protection !== "undefined" ||
				typeof allValues?.alarms?.surge_protection2 !== "undefined") && (
				<StatusCard
					state={"warning"}
			...
			{typeof allValues.alarms.high_wind_speed_alert !== "undefined" && (
				<StatusCard
					state={"warning"}
					title={t("alarm.wind.title")}
					activeText={t("alarm.wind.activeText")}
					inactiveText={t("alarm.wind.inactiveText")}
					active={allValues.alarms.high_wind_speed_alert}
					activePrimaryColor="#ffedb5"
					activeSecondaryColor="#665e48"
				/>
			)}
